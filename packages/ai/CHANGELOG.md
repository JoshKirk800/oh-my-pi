...
- Fixed `AuthStorage.reload()` exposing a partially refreshed credential view to generation subscribers when one external-store snapshot changes multiple providers; every update now applies before one generation transition ([#11717](https://github.com/can1357/oh-my-pi/pull/11717) by [@JoshKirk800](https://github.com/JoshKirk800)).
